...
const REALM_PATHS: RealmPath[] = [
  {
    ...
    lore: "Deep beneath volcanic peaks, ancient forges burn eternal. Master the art of bringing instances to life through factories, builders, and prototypes.",
  ...
  },
  {
    ...
    lore: "Impossibly tall spires of crystallized logic pierce the frozen sky. Compose objects into larger structures through adapters, bridges, and decorators.",
  ...
  },
  {
    ...
    lore: "Thunder never rests in this tempest realm. Ancient towers channel lightning between objects through observers, chains, and commands.",
