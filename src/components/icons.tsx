...
export function PotionIcon({ className = "", size = 24 }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M10 2v6.292a4 4 0 0 1-1.17 2.83L4.5 15.5A4 4 0 0 0 3 18.33V20a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-1.67a4 4 0 0 0-1.5-2.83l-4.33-4.378A4 4 0 0 1 14 8.292V2" />
      <path d="M8.5 2h7" />
      <path d="M7 16h10" />
    </svg>
  );
